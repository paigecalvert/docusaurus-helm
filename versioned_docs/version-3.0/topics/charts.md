...
which can be operated on fully. The [library chart](./library_charts) provides utilities or functions for the
...
functions](../howto/charts_tips_and_tricks).
...
as required in the chart template by using the ['required' function](../howto/charts_tips_and_tricks).
