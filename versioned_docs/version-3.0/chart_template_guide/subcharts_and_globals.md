...
> These limitations do not all necessarily apply to [library charts](/docs/topics/library_charts.md), which are designed to provide standardized helper functionality.
